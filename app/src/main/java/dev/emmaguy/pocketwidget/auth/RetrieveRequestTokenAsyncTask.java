...
public class RetrieveRequestTokenAsyncTask extends AsyncTask<Void, Void, String> {
    ...
    public RetrieveRequestTokenAsyncTask(String consumerKey,
            OnUrlRetrievedListener onUrlRetrievedListener,
    ...
    @Override protected String doInBackground(Void... params) {
        ...
        if (token != null && token.length() > 0) {
            ...
            return String.format("https://getpocket.com/auth/authorize?request_token=%s&redirect_uri=%s",
                    token,
                    CALLBACK_URL);
        }
        return null;
